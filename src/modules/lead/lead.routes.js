...
router
  .route('/')
  .post(auth('admin', 'manager', 'sales'), requireCheckedIn, validate(leadValidation.createLead), leadController.createLead)
...
router.patch('/:leadId/cnp', auth('admin', 'manager', 'sales'), requireCheckedIn, leadController.markCNP);
router.patch('/:leadId/uncnp', auth('admin', 'manager', 'sales'), requireCheckedIn, leadController.unmarkCNP);
router.post('/:leadId/notes', auth('admin', 'manager', 'sales'), requireCheckedIn, leadController.addNote);
router.post('/:leadId/follow-up', auth('admin', 'manager', 'sales'), requireCheckedIn, leadController.addFollowUp);
router.patch('/:leadId/next-follow-up', auth('admin', 'manager', 'sales'), requireCheckedIn, leadController.setNextFollowUp);
...
router
  ...
  .patch(auth('admin', 'manager', 'sales'), requireCheckedIn, validate(leadValidation.updateLead), leadController.updateLead)
